...
# 5. What was the most popular candy bar by the rating system for each gender in the dataset?

**Favourite candy by females**
```{r}
candy %>%
...
**Favourite candy by 'prefer not to say'**
```{r}
candy %>%
  select(gender, candy_type, rating) %>%
  filter(rating == "joy") %>%
